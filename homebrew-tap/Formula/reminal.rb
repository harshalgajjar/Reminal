class Reminal < Formula
  ...
  on_linux do
    on_arm do
      url "https://github.com/reminal/reminal/releases/download/v0.1.0/reminal_0.1.0_linux_arm64.tar.gz"
      sha256 "REPLACE_AFTER_RELEASE"
    end
    on_intel do
      url "https://github.com/reminal/reminal/releases/download/v0.1.0/reminal_0.1.0_linux_amd64.tar.gz"
      sha256 "REPLACE_AFTER_RELEASE"
    end
  end

class Reminal < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/harshalgajjar/Reminal/releases/download/v0.6.1/reminal_0.6.1_darwin_arm64.tar.gz"
      sha256 "a9ba78794edd018cece1d271006fecdd223435bdb948afdd602c29cb7102dc83"
    end
    on_intel do
      url "https://github.com/harshalgajjar/Reminal/releases/download/v0.6.1/reminal_0.6.1_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/harshalgajjar/Reminal/releases/download/v0.6.1/reminal_0.6.1_linux_arm64.tar.gz"
